...
const Countries:React.FunctionComponent<CounriesProps> = (props: CounriesProps) => {
 ...
 {loading && <p>Loading...</p>}
 {error && <p>Error :-(</p>}
 {data && <TableContainer style={{height:300}} component={Paper}>
